                ...
                <div className="pg-upload-file__content">
                    ...
                    <div className="pg-upload-file__content__form">
                        ...
                        <div className="pg-upload-file__content__form__info">
                            ...
                            {buttonText ? <span
                                className="pg-upload-file__content__form__info__button btn-primary">{buttonText}</span> : null}
                            {sizesText ?
                                <span className="pg-upload-file__content__form__info__text">{sizesText}</span> : null}
                            {formatsText ?
                                <span className="pg-upload-file__content__form__info__text">{formatsText}</span> : null}
                            {uploadedFile ? <span
                                className="pg-upload-file__content__form__info__text file">{uploadedFile}</span> : null}
                        </div>
                    </div>
                </div>
                {tipText ? (
