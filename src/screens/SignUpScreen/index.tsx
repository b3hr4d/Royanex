...
import {
    ...
    RootState,
    selectConfigs, selectCurrentColorTheme,
    selectCurrentLanguage,
    selectCurrentPasswordEntropy,
    selectSignUpError,
    selectSignUpRequireVerification,
    signUp, toggleSidebar,
} from '../../modules';
...
class SignUp extends React.Component<Props> {
    ...
    public render() {
        const {configs, loading, currentPasswordEntropy, colorTheme,signUpError} = this.props;
        const {
            email,
            password,
            confirmPassword,
        ...
        return (
            <div className="pg-sign-up-screen">
                <Background className="pg-sign-in-screen__background"/>
                <div className={className}>
                    <SignUpForm
                        ...
                        image={colorTheme === 'light' ? require('../../assets/images/logoLight.svg') : require('../../assets/images/logo.svg')}
                    />
                    <Modal
