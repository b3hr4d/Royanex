...
import {
    ...
    PROFILE_USER_ERROR,
    PROFILE_USER_FETCH,
    PROFILE_USER_INFO_DATA,
    PROFILE_USER_INFO_FETCH,
} from './constants';
...
export interface UserInfoFetch {
    type: typeof PROFILE_USER_INFO_FETCH;
}

export interface UserInfoData {
    type: typeof PROFILE_USER_INFO_DATA;
    payload: {
...
export const userInfoFetch = (): UserInfoFetch => ({
    type: PROFILE_USER_INFO_FETCH,
});

export const userInfoData = (payload: UserInfoData['payload']): UserInfoData => {
    return {
        type: PROFILE_USER_INFO_DATA,
        payload,
    };
};
