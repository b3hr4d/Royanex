...
import {Wallet, WalletAddress, WalletWithdrawCCY, WalletWithdrawRls,} from './types';
...
export const walletsWithdrawRlsFetch = (payload: WalletsWithdrawRlsFetch['payload']): WalletsWithdrawRlsFetch => ({
    type: WALLETS_WITHDRAW_RLS_FETCH,
    payload,
});

export const walletsWithdrawRlsError = (payload: WalletsWithdrawRlsError['payload']): WalletsWithdrawRlsError => ({
