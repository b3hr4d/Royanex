...
export const WALLETS_WITHDRAW_RLS_FETCH = 'wallets/WITHDRAW_RLS_FETCH';
export const WALLETS_WITHDRAW_RLS_DATA = 'wallets/WITHDRAW_RLS_DATA';
export const WALLETS_WITHDRAW_RLS_ERROR = 'wallets/WITHDRAW_RLS_ERROR';
