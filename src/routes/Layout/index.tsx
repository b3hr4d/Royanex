...
class LayoutComponent extends React.Component<LayoutProps, LayoutState> {
    ...
    public render() {
        ...
        const tradingCls = location.pathname.includes('/trading')
            ...
            : '';
        const sidebarActive =
            isActive && !location.pathname.includes('/trading')
                ? 'sidebarActive'
                : '';
        ...
        return (
            <div
                className={`container-fluid pg-layout ${tradingCls} ${sidebarActive}`}
            >
                <Switch>
                    <Route
                        exact={true}
    ...
    private handleRenderExpiredSessionModal = () => (
        <ExpiredSessionModal
            ...
            handleChangeExpSessionModalState={
                this.handleChangeExpSessionModalState
            }
