...
import injectIntl from 'react-intl/lib/components/injectIntl';
import {
    connect,
            ...
            <React.Fragment>
                <div className="cr-table-header__content">
                    {this.props.currentMarket
                        ?
                        <span>
                            {this.translate(`page.body.coins.${this.props.currentMarket.base_unit}`)}
                            /
                            {this.translate(`page.body.coins.${this.props.currentMarket.quote_unit}`)}
                        </span>
                        : ''}
                </div>
...
export const TradingChart = compose(
    injectIntl,
    connect(reduxProps, mapDispatchProps)
)(TradingChartComponent) as React.ComponentClass;
