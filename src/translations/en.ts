...
export const en = {
    ...
    'page.body.history.deposit.content.status.fee_processing': 'Calculating',
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
    ...
    'page.header.signIn.noAccountYet': 'Not Sign up yet?',
    ...
    'success.payment.confirmed': 'Payment request was received',
