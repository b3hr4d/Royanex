    ...
    const mainLinks = [
        {
            ...
            children: (
                <div>
                    <span
                        className="color-accent">{intl.formatMessage({id: 'page.mobile.profileLinks.link.verification'}, {level: user.level})}</span>
                    <ChevronIcon/>
                </div>
            ),
        },
        {
            titleKey: 'page.mobile.profileLinks.main.bankInfo',
            route: '/profile/bankInfo',
        },
        {
            ...
            children: (
                <div>
                    {user.otp ? (
                        <span
                            className="color-green">{intl.formatMessage({id: 'page.mobile.profileLinks.link.2fa.enabled'})}</span>
                    ) : (
                        <span
                            className="color-red">{intl.formatMessage({id: 'page.mobile.profileLinks.link.2fa.disabled'})}</span>
                    )}
                    <ChevronIcon/>
                </div>
            ),
    ...
    const settingsLinks = [
        {
            ...
            children: (
                <div>
                    <span
                        className="text-capitalize">{intl.formatMessage({id: `page.mobile.profileColorTheme.theme.${currentTheme}`})}</span>
                    <ChevronIcon/>
                </div>
            ),
        },
